...
public class FlashActivity extends AppCompatActivity {
    ...
    private MaterialButton btnGenerateFlashCards;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvGenerationStatus.setText(R.string.flash_generation_status_idle);
    ...
    private void generateFlashCards() {
        ...
        executorService.execute(() -> {
            try {
                ArrayList<FlashCard> cards = geminiQuizService.generateFlashCards(
                        apiKey,
                        questionCount,
                ...
                runOnUiThread(() -> {
                    setGenerating(false, getString(R.string.flash_generation_status_success), false);
                    openFlashQuestionActivity(cards);
                });
    ...
    private void openFlashQuestionActivity(ArrayList<FlashCard> cards) {
        if (cards == null || cards.isEmpty()) {
            setGenerating(false, getString(R.string.error_no_flash_cards_generated), true);
            return;
        }

        Intent intent = new Intent(this, FlashQuestionActivity.class);
        intent.putExtra(FlashQuestionActivity.EXTRA_FLASH_CARDS, cards);
    ...
    private void setGenerating(boolean isGenerating, String status, boolean isError) {
        btnGenerateFlashCards.setEnabled(!isGenerating);
        btnGenerateFlashCards.setText(isGenerating ? R.string.flash_generate_loading : R.string.flash_generate);
